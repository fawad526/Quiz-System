...
function initApp() {
    ...
    quiz = new Quiz(
        ...
        `Java Script Simple Quiz it is just basic of JS with multiple choice questions.The amount of question is 7 and at the end result is declared how much you have socred `,
        70,
        questions);
